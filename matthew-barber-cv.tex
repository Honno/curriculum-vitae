...
I'm a BSc Computer Science graduate experienced in using \tech{Python} for signal processing and data mining.
I can explore, preprocess and model for data to identify the underlying patterns that lead to useful insights.
